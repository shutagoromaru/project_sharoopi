...
ActiveRecord::Schema[7.0].define(version: 2023_09_05_115255) do
  ...
  create_table "consultings", charset: "utf8mb4", collation: "utf8mb4_0900_bin", force: :cascade do |t|
  ...
  create_table "responses", charset: "utf8mb4", collation: "utf8mb4_0900_bin", force: :cascade do |t|
    t.bigint "user_id", null: false
    ...
    t.datetime "updated_at", null: false
    t.string "title"
    t.index ["consulting_id"], name: "index_responses_on_consulting_id"
  ...
  add_foreign_key "responses", "consultings"
